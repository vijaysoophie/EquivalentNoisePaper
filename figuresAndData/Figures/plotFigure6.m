...
% 
noiseEstimatedByTSDModel    = [24817   2       4       8       17;      % ObserverID
...
figure;
hold on;
plot([0.9:4.9], noiseEstimatedByTSDModel(2,:),'o', 'MarkerSize', 12, 'color', [0.39,0.83,0.07], 'linewidth', 2);
plot([0.9:4.9], noiseEstimatedByTSDModel(3,:),'o', 'MarkerSize', 12, 'MarkerFaceColor', [0.00,0.45,0.74],'color', [0.00,0.45,0.74]);
