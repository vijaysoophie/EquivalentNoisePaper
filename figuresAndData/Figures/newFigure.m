% This script plots figure 5 (psychometric function for all observers) for 
% the Equivalent noise paper. The script requires Palamedes_1.9.0 toolbox. 
% The figure is saved in the folder 
% EquivalentNoisePaper/figuresAndData/Figures as newFigure.pdf.
%
% Aug 14 2021: Vijay Singh wrote this.
%
%%
clear; close all;
makeDataForNewFigure;
...
% save2pdf('AllPsycometricCurves.pdf',gcf,600);